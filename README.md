...
```
npm create cloudflare@latest -- --template=cloudflare/templates/durablechatapp
```

A live public deployment of this template is available at [https://durablechatapp.templates.workers.dev](https://durablechatapp.templates.workers.dev)
